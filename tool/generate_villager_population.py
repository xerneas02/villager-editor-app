...
POPULATION = {
    ...
    "goblin_raider": ("male", "goblin_raider", ("upturned", "elf_long", "bald", "#4D2E1F", None, None, "monster_raider", "sword_scabbard"), "idiot", "monster", "monster", ("anger", "fear", "surprise"), GOBLIN_RAIDER),
    ...
    "varkos_dragonkin": ("male", "dragonkin_warrior", ("aquiline", "elf_short", "bald", "#49372F", None, None, "monster_warrior", "sword_scabbard"), "barbarian", "villain", "barbarian", ("anger", "fear", "surprise"), GOBLIN_RAIDER),
